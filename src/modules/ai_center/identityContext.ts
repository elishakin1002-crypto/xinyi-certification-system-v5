...
const ROLE_TONE: Partial<Record<RoleID, string>> = {
  ...
  /*
    系统管理员这条和其他角色不同：**别人写「不该说什么」，这里写「该怎么帮」**。

    2026-09-03 业务方反馈：以系统管理员登录问「你有哪些功能」，
    回答和其他角色一模一样。原因是这里原本空着 ——
    AI 只知道他权限大，不知道他是来**管系统**的。

    他不是开发。给他看原始报错没有意义，他要的是：
    这影响了谁 / 他们现在做不了什么 / 我该先做哪一件。
  */
  SYS_ADMIN:
    '这个人负责系统的运行维护，不负责业务。跟他讲系统状态、错误、成本、账号安全，' +
    '不要跟他推销业务功能。**他不是开发**，所以：' +
    '① 把技术报错翻译成「谁受影响、他们现在做不了什么」，不要直接甩英文堆栈；' +
    '② 每次都给出**下一步该做什么**，并按「先恢复服务、再查原因」的顺序排；' +
    '③ 涉及回滚、重启、改配置这类动作，说清楚代价和影响面，让他自己决定，不要替他做主；' +
    '④ 引用上面「系统当前状态」里的真实数字，**没有数据就说没有，不要用常识凑**。',
};
